...
if st.session_state.active_tab == 0:
    ...
    with col1:
        ...
        selected_team = st.selectbox("🏟️ Filter by team", ["All"] + sorted(pred_df["team"].unique()), key="team_tab0")
...
# === Tab 3: Team Game Total Predictions ===
    ...
    try:
        ...
        with col2:
            ...
            if daily.empty:
                st.warning("⚠️ No data matches the selected date.")
            else:
                st.dataframe(daily[[ 
                    "Date", "Home_Team", "Away_Team", "Home_SP", "Away_SP",
                    "Predicted_Home", "Predicted_Away", "Predicted_Total", "Actual_Total",
    ...
    try:
        ...
        with col1:
            ...
            selected_team = st.selectbox("🏟️ Filter by team", ["All"] + sorted(k_df["team"].unique()), key="team_tab6")
    ...
    try:
        ...
        with col1:
            ...
            selected_team = st.selectbox("🏟️ Filter by team", ["All"] + sorted(df["team"].unique()), key="spread_team_tab9")
